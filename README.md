...
I nedded it for simple models, but it grows too big, so I decided to stop it and switch to something else: https://github.com/kildom/boiler-water-return-controller/tree/master/test/ModelToCpp
